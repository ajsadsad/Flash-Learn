...
function AnglesAndShapesPage() {
    ...
    const questions = [
        {
            question: "What is this shape: image",
            options: ["shape 1", "shape 2", "shape 3"],
            correctAnswer: "shape 2"
        },
        {
            question: "What is the angle of a right triangle?",
            options: ["90 degrees", "60 degrees", "45 degrees"],
    ...
    return (
        ...
        >
            ...
            <GridItem area={'header'} textAlign="center">
                <Text fontSize="4xl" fontWeight="bold" color="black">Angles And Shapes</Text> 
            </GridItem>
...
export default AnglesAndShapesPage;