...
import useMakeGeminiRequest from '../../hooks/useGeminiApi'; // Import the Gemini API hook
...
function AnglesAndShapesPage() {
    ...
    useEffect(() => {
        getGeminiResponse('Math', 'Kindergarten to Year 2', 'angles and shapes multiple choice');
    }, [getGeminiResponse]);
